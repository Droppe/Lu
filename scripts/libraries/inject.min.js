(function(context,undefined){function proxy(e,t){if(!t)throw new Error("proxying requires a scope");if(!e)throw new Error("proxying requires a function");return function(){return e.apply(t,arguments)}}function each(e,t){for(var n=0,r=e.length;n<r;n++)t(e[n])}var INJECT_VERSION="0.4.0-pre",IS_IE=

 ...
 */
function loadDecorator(a){return function(a){var b=this;this.on(constants.events.STATED,function(a,c){a.stopPropagation(),c.hasState(constants.states.LOADED)&&b.disable()})}}var constants=require("lu/constants");typeof module!="undefined"&&(typeof module.setExports=="function"?module.setExports(loadDecorator):module.exports&&(module.exports=loadDecorator));
...
Abstract = Class.create( ( function() {
  ...
  return {
    ...
    initialize: function( $element, settings ) {
      ...
      //         $observers;
      // 
      //       //$observers = $this.data( 'lu-controls' )[ '$observers' ];
      //       //$observers = $element.lu( 'getParent' ).lu( 'getControl' );
      //       //console.log( $element.lu( 'getParent' ) );
      //       //$element.lu( 'getParent' ).trigger( 'hello' );
      ...
      Abstract.observe = function( $observer ) {
        return $element.lu( 'observe', $observer );
      };
